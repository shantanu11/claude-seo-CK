...
### Added
- **Marketplace distribution**: Created `.claude-plugin/marketplace.json` for plugin marketplace submission. Users can now install via `/plugin marketplace add shantanu11/claude-seo-CK`
...
### Added
- **install.cat support**: Added alternative install method via `curl install.cat/shantanu11/claude-seo-CK | bash` to README (#10)
