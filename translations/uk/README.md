...
[![CI](https://github.com/shantanu11/claude-seo-CK/actions/workflows/ci.yml/badge.svg)](https://github.com/shantanu11/claude-seo-CK/actions/workflows/ci.yml)
[![Claude Code Skill](https://img.shields.io/badge/Claude%20Code-Skill-blue)](https://claude.ai/claude-code)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](../../LICENSE)
[![Version](https://img.shields.io/github/v/release/shantanu11/claude-seo-CK)](https://github.com/shantanu11/claude-seo-CK/releases)
...
/plugin marketplace add shantanu11/claude-seo-CK

# Install plugin
/plugin install claude-seo@shantanu11-claude-seo-CK
```
...
```bash
curl -fsSL https://raw.githubusercontent.com/shantanu11/claude-seo-CK/main/install.sh | bash
```

Або через [install.cat](https://install.cat):

```bash
curl -fsSL install.cat/shantanu11/claude-seo-CK | bash
```

Бажаєте переглянути скрипт перед запуском?

```bash
curl -fsSL https://raw.githubusercontent.com/shantanu11/claude-seo-CK/main/install.sh > install.sh
...
```bash
curl -fsSL https://raw.githubusercontent.com/shantanu11/claude-seo-CK/main/uninstall.sh | bash
```
...
[Claude Banana](https://github.com/shantanu11/claude-seo-CK) Creative Director.
...
|---------|-----------|----------------|
| [Claude SEO](https://github.com/shantanu11/claude-seo-CK) | SEO-аналіз, аудити, Schema, GEO | Ядро — аналізує сайти, генерує плани дій |
| [Claude Blog](#) | Написання блогів, оптимізація, оцінювання | Компаньйон — створення контенту на основі SEO-знахідок |
| [Claude Banana](https://github.com/shantanu11/claude-seo-CK) | Генерація AI-зображень через Gemini | Спільний — генерація зображень для SEO та блогів |
...
Створено для Claude Code [@shantanu11](https://github.com/shantanu11)
