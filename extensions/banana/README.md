...
> This extension wraps [Claude Banana](https://github.com/shantanu11/claude-seo-CK)
...
This removes the skill and agent. If you also use [Claude Banana](https://github.com/shantanu11/claude-seo-CK),
